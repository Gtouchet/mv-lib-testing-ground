...
@Component({
    ...
    template: `
        ...
        <p style='color: red'>
            ...
            The button and textbox components are the only ones that are fully refactored.<br/>
            The toast component is also working, but it's configuration interface is not working properly.
        </p>
    `,
